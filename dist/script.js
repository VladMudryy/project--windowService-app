...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.no_click', '.decoration_content-item', 'after_click');
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', '2022-08-17');
...
function changeModalState(state) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["checkDigits"])('#width');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["checkDigits"])('#height');
...
function forms(state) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["checkDigits"])('input[name="user-phone"]'); // Form submit

  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      event.preventDefault();
      var statusAsnswer = document.createElement('div');
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        if (item.getAttribute('data-calc') === "end") {
          state = {};
          Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["closeModal"])(closeCalcForm);
        }
...
var gallery = function gallery() {
  var parentGallery = document.querySelector('.works'),
  ...
  parentGallery.addEventListener('click', function (event) {
    event.preventDefault();
    var target = event.target;

    if (target && target.classList.contains('preview')) {
      imagesPopup.style.display = 'flex';
      var imgSrc = target.parentNode.getAttribute('href');
...
function modal() {
  function createModal(_ref) {
    var clickedModal = _ref.clickedModal,
        modalClass = _ref.modalClass,
        closeClass = _ref.closeClass,
        activeClass = _ref.activeClass,
        _ref$prevModal = _ref.prevModal,
        prevModal = _ref$prevModal === void 0 ? null : _ref$prevModal,
        _ref$closeOverlay = _ref.closeOverlay,
        closeOverlay = _ref$closeOverlay === void 0 ? true : _ref$closeOverlay;
    var startModal = document.querySelectorAll(clickedModal),
        modal = document.querySelector(modalClass),
        prev = document.querySelector(prevModal);
    startModal.forEach(function (item) {
      item.addEventListener('click', function (event) {
        if (prevModal) {
          Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["closeModal"])(prev, activeClass);
          Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["openModal"])(modal, activeClass);
        } else {
          Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["openModal"])(modal, activeClass);
        }
      });
    ...
    modal.addEventListener('click', function (event) {
      if ((event.target.classList.contains(modalClass.slice(1)) || event.target.closest(closeClass)) && closeOverlay) {
        Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["closeModal"])(modal, activeClass);
  ...
  showModalByTimer('.popup', 'modal-open', 60000); // Calculator modals
...
function tabs(tabTrigger, tabContent, activeClass) {
  ...
  var trigger = document.querySelectorAll(tabTrigger),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(classSelector, deadline) {
  ...
  function setTimer(selector) {
    var timerId = document.querySelector(selector),
...
/*!*************************************!*\
  !*** ./src/js/services/services.js ***!
  \*************************************/
/*! exports provided: openModal, closeModal, checkDigits */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkDigits", function() { return checkDigits; });
...
var scrollRight = calcScroll();

function openModal(modalClass) {
  var activeClass = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'modal-open';
  modalClass.style.display = 'block';
  document.querySelector('body').classList.add(activeClass);
  document.querySelector('body').style.marginRight = "".concat(scrollRight, "px");
}
